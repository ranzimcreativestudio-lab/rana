-- Walk Me Bicycle Print Tee (r06) — Supabase → SQL Editor → Run
insert into public.products
  (slug, name, gender, type, shape, price, old_price, tag, img, fabric, fit, care, colors, sizes, sort)
values
  ('r06', 'Walk Me Bicycle Print Tee', 'men', 'T-Shirt', 'tee', 180, null, 'New', 'images/royalblue-walk-tee.jpg',
   'Cotton jersey with a front bicycle print', 'Regular, straight body', 'Wash inside out, cold water, do not iron the print',
   '[{"n":"Royal Blue","h":"#19348C"}]'::jsonb,
